...
const AUTH0_CONFIG = {
  ...
  httpInterceptor: {
    allowedList: [
      { uri: `${environment.api.scheme}://${environment.api.path}/${environment.api.routes.secured}/*` },
      { uri: `${environment.api.scheme}://${environment.api.path}/${environment.api.routes.develop}` },
    ]
  },
